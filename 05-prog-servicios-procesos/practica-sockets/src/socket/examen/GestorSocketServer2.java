...
public class GestorSocketServer2 implements Runnable { // Runnable para poder implementar en el multihilo

	private Socket socket;

	public GestorSocketServer2(Socket socket) {
		this.socket = socket;
	}
	...
	private String procesarMensaje(String mensaje) {
		...
		// Validar formato básico (debe tener al menos 3 partes considerando los #
		// inicial y final)
		if (partes.length < 3) {
			return "#Error#";
		}
